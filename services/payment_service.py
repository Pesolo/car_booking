...
class PaymentService:
    ...
    def initiate_payment(self, booking_id, email):
        ...
        payload = {
            ...
            "metadata": {"booking_id": booking_id, "type": "parking_booking"},
        }
    ...
    def handle_payment_callback(self, reference):
        ...
        try:
            ...
            # If still not successful → return pending instead of raising
            if payment_data["status"] != "success":
                logger.info(f"Payment {reference} still pending")
            ...
            self.booking_service.update_booking_status(
                booking_id,
                "confirmed",
                {
                    "qr_data": qr_data,
